...
const char PASSWORD[] = "shhhhhh_secret";
...
void send_to_608(double lat, double lng){
  ...
  sprintf(request,"GET  http://608dev-2.net/sandbox/sc/jds99/lab03b/demo_loc.py?lat=%f&lng=%f HTTP/1.1\r\n", lat, lng);
