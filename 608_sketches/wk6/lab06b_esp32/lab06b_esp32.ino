...
const char POST_URL[] = "POST http://608dev-2.net/sandbox/sc/porderiq/lab06/lab06.py HTTP/1.1\r\n"; //CHANGE THIS TO YOUR TEAM'S URL
...
void loop() {
  ...
  if (bmp280.getMeasurements(temperature, pressure, altitude)) {
    if (millis() - posting_timer > POSTING_PERIOD) {
      ...
      sprintf(body, "user=%s&temp=%f&pressure=%f", USER, temperature, pressure); //generate body, posting temp, humidity to server
